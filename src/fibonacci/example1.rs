...
impl<F: FieldExt> FiboChip<F> {
    ...
    pub fn configure(
        ...
        meta.enable_equality(col_a); // allow copying of values from 1 row to the next by Permutation Argument
    ...
    pub fn assign_row(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let c_val = prev_b.0.value().copied() + prev_c.0.value(); // contraint: c = a + b
...
mod tests {
    ...
    #[test]
    fn test_example1() {
        let k = 4; // number of rows avilable, min of 4 is needed here
